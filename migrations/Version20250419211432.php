 ...
 */
final class Version20250419211432 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE article (id INT AUTO_INCREMENT NOT NULL, category_id INT NOT NULL, place_id INT DEFAULT NULL, district_id INT DEFAULT NULL, city_id INT DEFAULT NULL, island_id INT DEFAULT NULL, country_id INT DEFAULT NULL, name VARCHAR(255) NOT NULL, content LONGTEXT NOT NULL, start_at DATETIME DEFAULT NULL, end_at DATETIME DEFAULT NULL, type VARCHAR(255) NOT NULL, slug VARCHAR(255) NOT NULL, created_by VARCHAR(255) DEFAULT NULL, updated_by VARCHAR(255) DEFAULT NULL, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, UNIQUE INDEX UNIQ_23A0E66989D9B62 (slug), INDEX IDX_23A0E6612469DE2 (category_id), INDEX IDX_23A0E66DA6A219 (place_id), INDEX IDX_23A0E66B08FA272 (district_id), INDEX IDX_23A0E668BAC62AF (city_id), INDEX IDX_23A0E66B0EEFA16 (island_id), INDEX IDX_23A0E66F92F3E70 (country_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE city (id INT AUTO_INCREMENT NOT NULL, island_id INT DEFAULT NULL, country_id INT NOT NULL, name VARCHAR(255) NOT NULL, slug VARCHAR(255) NOT NULL, UNIQUE INDEX UNIQ_2D5B0234989D9B62 (slug), INDEX IDX_2D5B0234B0EEFA16 (island_id), INDEX IDX_2D5B0234F92F3E70 (country_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE country (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(255) NOT NULL, slug VARCHAR(255) NOT NULL, UNIQUE INDEX UNIQ_5373C966989D9B62 (slug), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE district (id INT AUTO_INCREMENT NOT NULL, city_id INT NOT NULL, island_id INT DEFAULT NULL, country_id INT NOT NULL, name VARCHAR(255) NOT NULL, slug VARCHAR(255) NOT NULL, UNIQUE INDEX UNIQ_31C15487989D9B62 (slug), INDEX IDX_31C154878BAC62AF (city_id), INDEX IDX_31C15487B0EEFA16 (island_id), INDEX IDX_31C15487F92F3E70 (country_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE island (id INT AUTO_INCREMENT NOT NULL, country_id INT NOT NULL, name VARCHAR(255) NOT NULL, slug VARCHAR(255) NOT NULL, UNIQUE INDEX UNIQ_A90F6FEA989D9B62 (slug), INDEX IDX_A90F6FEAF92F3E70 (country_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE menu (id INT AUTO_INCREMENT NOT NULL, parent_id INT DEFAULT NULL, page_id INT DEFAULT NULL, category_id INT DEFAULT NULL, name VARCHAR(255) NOT NULL, menu_order INT NOT NULL, path VARCHAR(255) DEFAULT NULL, type VARCHAR(255) NOT NULL, icon VARCHAR(255) DEFAULT NULL, url VARCHAR(255) DEFAULT NULL, INDEX IDX_7D053A93727ACA70 (parent_id), UNIQUE INDEX UNIQ_7D053A93C4663E4 (page_id), UNIQUE INDEX UNIQ_7D053A9312469DE2 (category_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE place (id INT AUTO_INCREMENT NOT NULL, district_id INT DEFAULT NULL, city_id INT DEFAULT NULL, island_id INT DEFAULT NULL, country_id INT NOT NULL, name VARCHAR(255) NOT NULL, address VARCHAR(255) NOT NULL, latitude DOUBLE PRECISION NOT NULL, longitude DOUBLE PRECISION NOT NULL, slug VARCHAR(255) NOT NULL, UNIQUE INDEX UNIQ_741D53CD989D9B62 (slug), INDEX IDX_741D53CDB08FA272 (district_id), INDEX IDX_741D53CD8BAC62AF (city_id), INDEX IDX_741D53CDB0EEFA16 (island_id), INDEX IDX_741D53CDF92F3E70 (country_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE article ADD CONSTRAINT FK_23A0E66B0EEFA16 FOREIGN KEY (island_id) REFERENCES island (id)');
        ...
        $this->addSql('ALTER TABLE district ADD CONSTRAINT FK_31C15487B0EEFA16 FOREIGN KEY (island_id) REFERENCES island (id)');
        $this->addSql('ALTER TABLE district ADD CONSTRAINT FK_31C15487F92F3E70 FOREIGN KEY (country_id) REFERENCES country (id)');
        $this->addSql('ALTER TABLE island ADD CONSTRAINT FK_A90F6FEAF92F3E70 FOREIGN KEY (country_id) REFERENCES country (id)');
        ...
        $this->addSql('ALTER TABLE place ADD CONSTRAINT FK_741D53CDB0EEFA16 FOREIGN KEY (island_id) REFERENCES island (id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE article DROP FOREIGN KEY FK_23A0E66B0EEFA16');
        ...
        $this->addSql('ALTER TABLE district DROP FOREIGN KEY FK_31C15487B0EEFA16');
        $this->addSql('ALTER TABLE district DROP FOREIGN KEY FK_31C15487F92F3E70');
        $this->addSql('ALTER TABLE island DROP FOREIGN KEY FK_A90F6FEAF92F3E70');
        ...
        $this->addSql('ALTER TABLE place DROP FOREIGN KEY FK_741D53CDB0EEFA16');
        $this->addSql('ALTER TABLE place DROP FOREIGN KEY FK_741D53CDF92F3E70');
